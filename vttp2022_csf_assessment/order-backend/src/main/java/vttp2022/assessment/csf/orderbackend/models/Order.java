...
public class Order {
	...
	public static Order create(String json) {
		...
		ord.setThickCrust(data.getBoolean("thick_crust"));
		ord.setToppings(data.getString("toppings"));
		ord.setComments(data.getString("comments"));      

        return ord;
    }

	private void setToppings(String string) {
